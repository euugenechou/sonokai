...
call sonokai#highlight('DiffText', s:palette.blue, s:palette.diff_blue)
...
call sonokai#highlight('MoreMsg', s:palette.yellow, s:palette.none, 'bold')
...
call sonokai#highlight('Pmenu', s:palette.fg, s:palette.bg0)
call sonokai#highlight('PmenuSbar', s:palette.none, s:palette.bg0)
call sonokai#highlight('PmenuSel', s:palette.bg0, s:palette.bg_green)
call sonokai#highlight('WildMenu', s:palette.yellow, s:palette.bg0)
call sonokai#highlight('PmenuThumb', s:palette.none, s:palette.bg0)
...
call sonokai#highlight('StatusLine', s:palette.fg, s:palette.bg0)
call sonokai#highlight('StatusLineTerm', s:palette.fg, s:palette.bg0)
call sonokai#highlight('StatusLineNC', s:palette.grey, s:palette.bg0)
call sonokai#highlight('StatusLineTermNC', s:palette.grey, s:palette.bg0)
call sonokai#highlight('TabLine', s:palette.fg, s:palette.bg0)
call sonokai#highlight('TabLineFill', s:palette.bg0, s:palette.bg0)
